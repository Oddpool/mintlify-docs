...
| `BENCHKIT_MODEL` | No | Model to use (default: `claude-haiku-4-5-20251001`) |
| `BENCHKIT_MAX_TURNS` | No | Max agent turns (default: `30`) |
...
# (set BENCHKIT_MODEL=claude-sonnet-4-20250514 on your dashboard)
...
To switch models, update `BENCHKIT_MODEL` on your [dashboard](https://benchspan.com/dashboard/settings/profile):

| Model | `BENCHKIT_MODEL` value |
|---|---|
